DELIMITER ;;
CREATE PROCEDURE `calc_survey_school_student_5`()
BEGIN
  ...
  DECLARE colunas_surveys CURSOR FOR SELECT column_name FROM information_schema.columns
    WHERE table_name='survey_students_responses_2015_school_5ano' AND column_name LIKE 'TX_RESP_Q%';
  ...
  loop_leitura: LOOP
    ...
    INSERT INTO fact_question_students_5
      ...
      SUM(:column = \'*\') AS erase,
      0 AS sampling_error
      FROM survey_students_responses_2015_school_5ano AS sdr
