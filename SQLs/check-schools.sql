-- Escolas
  SELECT
    ...
    ROUND(IF(
      ...
      IF(
          t.discipline_id=1,
          e.nivel_5_LP5+e.nivel_4_LP5+e.nivel_6_LP5+e.nivel_9_LP5+e.nivel_8_LP5+e.nivel_7_LP5,
          e.nivel_5_MT5+e.nivel_6_MT5+e.nivel_10_MT5+e.nivel_9_MT5+e.nivel_8_MT5+e.nivel_7_MT5
        ),
      IF(
          t.discipline_id=1,
          e.nivel_5_LP9+e.nivel_4_LP9+e.nivel_6_LP9+e.nivel_7_LP9+e.nivel_8_LP9,
          e.nivel_5_MT9+e.nivel_6_MT9+e.nivel_8_MT9+e.nivel_7_MT9+e.nivel_9_MT9
        )
    ...
    ROUND(IF(
      ...
      IF(
          t.discipline_id=1,
          e.ate_nivel_1_LP5, 
          e.nivel_2_MT5+e.nivel_1_MT5+e.nivel_0_MT5
        ),
      IF(
          t.discipline_id=1,
          e.nivel_0_LP9,
          e.nivel_1_MT9+e.nivel_0_MT9
        )
    ...
    ROUND(IF(
      ...
      IF(
          t.discipline_id=1,
          e.nivel_2_LP5+e.nivel_3_LP5,
          e.nivel_3_MT5+e.nivel_4_MT5
        ),
      IF(
          t.discipline_id=1,
          e.nivel_3_LP9+e.nivel_2_LP9+e.nivel_1_LP9,
          e.nivel_2_MT9+e.nivel_3_MT9+e.nivel_4_MT9
        )
    ...
    ROUND(IF(
      ...
      IF(
          t.discipline_id=1,
          e.nivel_5_LP5+e.nivel_4_LP5,
          e.nivel_5_MT5+e.nivel_6_MT5
        ),
      IF(
          t.discipline_id=1,
          e.nivel_5_LP9+e.nivel_4_LP9,
          e.nivel_5_MT9+e.nivel_6_MT9
        )
    ...
    ROUND(IF(
      ...
      IF(
          t.discipline_id=1,
          e.nivel_6_LP5+e.nivel_9_LP5+e.nivel_8_LP5+e.nivel_7_LP5,
          e.nivel_10_MT5+e.nivel_9_MT5+e.nivel_8_MT5+e.nivel_7_MT5
        ),
      IF(
          t.discipline_id=1,
          e.nivel_6_LP9+e.nivel_7_LP9+e.nivel_8_LP9,
          e.nivel_8_MT9+e.nivel_7_MT9+e.nivel_9_MT9
        )
    ...
    ABS(t.average-IF(t.grade_id = 5,
            ...
            IF(t.discipline_id = 1,
                e.media_9EF_LP,
                e.media_9EF_MT)))  AS average_check,
  ...
  ON
    e.ID_DEPENDENCIA_ADM = t.dependence_id
                ...
                AND e.ID_ESCOLA = t.ID_ESCOLA_ALUNO 
