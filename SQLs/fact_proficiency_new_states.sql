...
INSERT INTO fact_proficiency_new
  ...
  ON
    t.dependence_id=s.dependence_id AND t.discipline_id=s.discipline_id AND t.grade_id=s.grade_id AND t.localization_id=s.localization_id AND t.state_id=s.state_id AND t.city_id=0 AND t.school_id=0
...
INSERT INTO fact_proficiency_new
  ...
  INNER JOIN
    provabrasil_2013.aggregation_tmp AS t
  ON
    t.dependence_id=s.dependence_id AND t.discipline_id=s.discipline_id AND t.grade_id=s.grade_id AND t.localization_id=0 AND t.state_id=s.state_id AND t.city_id=0 AND t.school_id=0
  GROUP BY t.dim_regional_aggregation, t.dim_politic_aggregation;
...
INSERT INTO fact_proficiency_new
  ...
  INNER JOIN
    provabrasil_2013.aggregation_tmp AS t
  ON
    t.dependence_id=0 AND t.discipline_id=s.discipline_id AND t.grade_id=s.grade_id AND t.localization_id=s.localization_id AND t.state_id=s.state_id AND t.city_id=0 AND t.school_id=0
...
INSERT INTO fact_proficiency_new
  ...
  INNER JOIN
    provabrasil_2013.aggregation_tmp AS t
  ON
    t.dependence_id=0 AND t.discipline_id=s.discipline_id AND t.grade_id=s.grade_id AND t.localization_id=0 AND t.state_id=s.state_id AND t.city_id=0 AND t.school_id=0
  WHERE s.dependence_id<>4
  GROUP BY t.dim_regional_aggregation, t.dim_politic_aggregation;
  COMMIT;